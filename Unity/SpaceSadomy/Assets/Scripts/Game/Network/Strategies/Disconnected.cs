...
namespace Nebula
{
    ...
    public class Disconnected : IGameLogicStrategy
    {
        ...
        /// The event.
        /// </param>
        public void OnEventReceive(NetworkGame gameLogic, EventData @event)
        {
        ...
        /// </param>
        public void OnOperationReturn(NetworkGame gameLogic, OperationResponse operationResponse)
        {
