...
namespace Nebula
{
    public class WorldData
    {
        ...
        public WorldData(string worldId, Vector3 cornerMin, Vector3 cornerMax, Vector3 tileDimensions, LevelType levelType) {
            SetWorldParameters(worldId, cornerMin, cornerMax, tileDimensions, levelType);
        }
