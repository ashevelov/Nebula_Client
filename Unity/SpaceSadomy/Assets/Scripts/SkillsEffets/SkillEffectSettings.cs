...
public class SkillEffectSettings : MonoBehaviour 
{
    ...
    public event EventHandler<SkillCollisionInfo> CollisionEnter;
    ...
    public void OnCollisionHandler(SkillCollisionInfo e)
    {
    ...
    public void RegistreActiveElement(GameObject go, float time)
    {
        ...
        active_value[lastInactiveIndex] = time;
        ++lastActiveIndex;
    }
...
public class SkillCollisionInfo : EventArgs
{
